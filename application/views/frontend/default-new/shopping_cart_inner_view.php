                ...
                <table class="table ">
                    ...
                    <tbody>
                        ...
                        foreach ($this->session->userdata('cart_items') as $item) : ?>
                            ...
                            <?php
                            if ($item['type'] == "course") {
                                $course_details = $this->crud_model->get_course_by_id($item['id'])->row_array();
                            } elseif ($item['type'] == "section") {
                                $course_details = $this->crud_model->get_section_by_id($item['id'])->row_array();
                            } else {
                                $course_details = $this->crud_model->get_lession_by_id($item['id'])->row_array();
                            }
                            ...
                            ?> <tr>
                                ...
                                <td class="text-end">
                                    <a class="ms-auto" href="#" onclick="actionTo('<?php echo site_url('home/handle_cart_items/' . $course_details['id'] .'/' . $item['type']); ?>');"><i class="fa-solid fa-trash-can"></i></a>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
