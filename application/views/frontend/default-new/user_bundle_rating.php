...
<?php if($user_bundle_rating->num_rows() > 0): ?>
	...
	<div class="w-100 px-4 py-3">
		<form action="javascript:;">
			...
			<div class="form-group mb-3">
				<textarea id="user_bundle_comment" class="form-control" name="comment"  style="background: #261954; color: #fff;"><?= $user_bundle_rating['comment'] ?></textarea>
			</div>
			<div class="row">
				<div class="col-md-12">
					<button onclick="bundle_rating('<?= $bundle_id; ?>')" type="button" class="btn btn-primary float-end" data-bs-dismiss="modal"><?= site_phrase('update_rating') ?></button>
				</div>
			</div>
		</form>
	</div>
<?php else: ?>
	...
	<div class="w-100 px-4 py-3">
		<form action="javascript:;">
			...
			<div class="row">
				<div class="col-md-12">
					<button onclick="bundle_rating('<?= $bundle_id; ?>')" class="btn btn-primary float-end" type="button" data-bs-dismiss="modal"><?= site_phrase('publish_rating') ?></button>
				</div>
			</div>
		</form>
	</div>
