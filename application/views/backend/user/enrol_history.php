        ...
        <div class="card">
            <div class="card-body">
              ...
              <div class="row justify-content-md-center">
                  <div class="col-xl-6">
                      <form class="form-inline" action="<?php echo site_url('user/enrol_history/filter_by_date_range') ?>" method="get">
                          <div class="col-xl-10">
                      ...
                      <table class="table table-striped table-centered mb-0">
                          ...
                          <tbody>
                              <?php foreach ($enrol_history->result_array() as $enrol):
                                  ...
                                  if($enrol['sections'] !=null){
                                    $course_data = $this->db->get_where('section', array('id' => $enrol['sections']))->row_array();

                                  }elseif($enrol['lession'] !=null){
                                    $course_data = $this->db->get_where('lesson', array('id' => $enrol['lession']))->row_array();
                                  ...
                                  <tr class="gradeU">
                                      ...
                                      <td><strong><a href="<?php echo site_url('user/course_form/course_edit/'.$course_data['id']); ?>" target="_blank"><?php echo $course_data['title']; ?></a></strong></td>
                                      ...
                                      <td>
                                          <button type="button" class="btn btn-outline-danger btn-icon btn-rounded btn-sm" onclick="confirm_modal('<?php echo site_url('user/enrol_history_delete/'.$enrol['id']); ?>');"> <i class="dripicons-trash"></i> </button>
                                      </td>
                                  </tr>
                              <?php endforeach; ?>
                          </tbody>
