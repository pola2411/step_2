            ...
            <div class="col-xl-12">
                <div class="form-group row mb-3">
                    <div class="offset-md-2 col-md-10">
                        <div class="custom-control custom-checkbox">
                            <input type="checkbox" class="custom-control-input" name="is_free_course1" id="is_free_course1" <?php if ($lesson_details['is_free_course'] == 1) echo 'checked'; ?> value="1" onclick="togglePriceFields(this.id)">
                ...
                <div class="paid-course-stuffs">
                    <div class="form-group row mb-3">
                        ...
                        <div class="col-md-10">
                            <input type="number" class="form-control" id="price1" name="price1" placeholder="<?php echo get_phrase('enter_course_course_price'); ?>" value="<?php echo $lesson_details['price']; ?>" min="0">
                        </div>
                    </div>
                    ...
                    <div class="form-group row mb-3">
                        <div class="offset-md-2 col-md-10">
                            <div class="custom-control custom-checkbox">
                                <input type="checkbox" class="custom-control-input" name="discount_flag1" <?php if ($lesson_details['discount_flag'] == 1) echo 'checked'; ?>  id="discount_flag1" value="1">
                    ...
                    <div class="form-group row mb-3">
                        ...
                        <div class="col-md-10">
                            <input type="number" class="form-control" name="discounted_price1" id="discounted_price1" onkeyup="calculateDiscountPercentage1(this.value)" value="<?php echo $lesson_details['discounted_price']; ?>" min="0">
