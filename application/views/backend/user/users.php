        ...
        <div class="card">
            <div class="card-body">
                <h4 class="page-title"> <i class="mdi mdi-apple-keyboard-command title_icon"></i> <?php echo $page_title; ?>
                    <a href="<?php echo site_url('user/user_form/add_user_form'); ?>" class="btn btn-outline-primary btn-rounded alignToTitle"><i class="mdi mdi-plus"></i><?php echo get_phrase('add_student'); ?></a>
                </h4>
            </div> <!-- end card body-->
        </div> <!-- end card -->
    </div><!-- end col-->
...
<script>
  $(document).ready(function () {
     var table = $('#server_side_users_data').DataTable({
      ...
      "ajax":{
        "url": "<?php echo base_url('user/server_side_users_data') ?>",
        "dataType": "json",
        "type": "POST",
      ...
      "columns": [
        ...
        { "data": "email" },
        { "data": "phone" },
        { data: "enrolled_courses", orderable: false, defaultContent: "none" }, // Set default content for null values
