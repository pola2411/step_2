            ...
            <div class="col-xl-12">
                <div class="card bg-light text-seconday on-hover-action mb-5" id = "section-<?php echo $section['id']; ?>">
                    <div class="card-body">
                        ...
                        <?php if ($section['is_free_course'] == null) : ?>
                                                <?php if ($section['discount_flag'] == 1) : ?>
                                                    <span class="badge badge-dark-lighten"><?php echo currency($section['discounted_price']); ?></span>
                                                <?php else : ?>
                                                    <span class="badge badge-dark-lighten"><?php echo currency($section['price']); ?></span>
                                                <?php endif; ?>
                                            <?php elseif ($section['is_free_course'] == 1) : ?>
                            ...
                            <div class="card text-secondary on-hover-action mb-2 w-100" id = "<?php echo 'lesson-'.$lesson['id']; ?>">
                                <div class="card-body thinner-card-body">
                                    ...
                                    <h5 class="card-title mb-0">
                                        ...
                                        <?php if ($lesson['is_free_course'] == null) : ?>
                                                <?php if ($lesson['discount_flag'] == 1) : ?>
                                                    <span class="badge badge-dark-lighten"><?php echo currency($lesson['discounted_price']); ?></span>
                                                <?php else : ?>
                                                    <span class="badge badge-dark-lighten"><?php echo currency($lesson['price']); ?></span>
                                                <?php endif; ?>
                                            <?php elseif ($lesson['is_free_course'] == 1) : ?>
                                                <span class="badge badge-success-lighten"><?php echo get_phrase('free'); ?></span>
                                            <?php endif; ?>
                                    </h5>
                                </div>
