    ...
    <div class="col-xl-12">
        <div class="card">
            <div class="card-body">
                ...
                <form class="required-form" action="<?php echo site_url('user/users/add'); ?>" enctype="multipart/form-data" method="post">
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                $.each(response, function(key, value) {
                    $('#multiple_course_id2').append('<option value="' + value.id + '" >' + value.title + '</option>');
                });
            }
        });
    }
