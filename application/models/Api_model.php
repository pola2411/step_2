...
class Api_model extends CI_Model
{
	...
	// get the top courses
	public function top_courses_get($top_course_id = "",$level_id="")
	{
		if ($top_course_id != "") {
	...
	public function get_results_by_user_id($user_id = "") {
		...
		,quiz_results.total_obtained_marks,lesson.attachment
		');
	...
	public function all_silders()
	{
		...
		foreach ($categories as $key => $category) {
			$categories[$key]['thumbnail'] = $this->user_model->get_user_image_url($category['image']);
